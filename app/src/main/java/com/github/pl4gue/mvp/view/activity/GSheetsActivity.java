...
public class GSheetsActivity extends BaseActivity implements GSheetsView, EasyPermissions.PermissionCallbacks {
    ...
    public static Intent getCallingIntent(Context context) {
        return new Intent(context, GSheetsActivity.class);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new GSheetsPresenter();
    ...
    private void getResultsFromApi() {
        if (!isGooglePlayServicesAvailable()) {
            ...
            new GSheetsActivity.MakeRequestTask(mCredential).execute();
        }
    }
